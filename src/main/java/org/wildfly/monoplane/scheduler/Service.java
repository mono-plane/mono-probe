...
import org.wildfly.monoplane.scheduler.diagnose.StorageReporter;
import org.wildfly.monoplane.scheduler.polling.ClientFactoryImpl;
import org.wildfly.monoplane.scheduler.polling.IntervalBasedScheduler;
...
/**
 * The core service that creates task lists from a {@link org.wildfly.monoplane.scheduler.config.Configuration}
 * and schedules work through a {@link org.wildfly.monoplane.scheduler.polling.Scheduler}.
 * The resulting data will be pushed to a {@link org.wildfly.monoplane.scheduler.storage.StorageAdapter}
 *
 * @author Heiko Braun
 * @since 10/10/14
 */
