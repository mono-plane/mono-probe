package org.wildfly.monoplane.probe.service;
...
import org.wildfly.monoplane.scheduler.config.Interval;
...
public class ProbeService implements Service<ProbeService> {
    ...
    private org.wildfly.monoplane.scheduler.Service schedulerService;
    ...
    public ProbeService(ModelNode config) {
    ...
    public static ServiceController<ProbeService> createService(final ServiceTarget target,
                                                                     final ServiceVerificationHandler verificationHandler,
                                                                     ModelNode config) {

        ProbeService service = new ProbeService(config);
    ...
    private void startScheduler(StartContext startContext) {
        ...
        schedulerService = new org.wildfly.monoplane.scheduler.Service(schedulerConfig, new ModelControllerClientFactory() {
            @Override
    ...
    @Override
    public ProbeService getValue() throws IllegalStateException, IllegalArgumentException {
        return this;
    }
